    ...
    <div class="flex justify-center items-center px-[64px]">
        ...
        <form class="flex flex-col gap-4 max-w-[600px]" action="" method="POST">
            ...
            <label class="flex flex-col gap-2">
                <span>Email</span>
                <input type="email" name="email" class="input input-bordered input-md" placeholder="Enter your Email"
                    required />
            </label>
            ...
            <label class="flex flex-col gap-2" x-data="{show: true}">
                <span>Password</span>
                <div class="relative">
                    <input type="password" name="password" class="input input-bordered input-md w-full"
                        placeholder="Enter your Password" required x-bind:type="show ? 'password' : 'text'">
                    <button type="button"
