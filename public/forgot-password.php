    ...
    <div class="h-full flex justify-center items-center flex-col h-full">
        <div class="w-[500px] h-[500px]">
            ...
            <div class="flex flex-col justify-center items-center gap-4 mb-8">
                ...
                <span class="text-base text-center">Oops, locked out? No worries! If you've forgotten your password, Enter your email address below. We'll guide you through a quick verification process to ensure account security.</span>
            </div>
