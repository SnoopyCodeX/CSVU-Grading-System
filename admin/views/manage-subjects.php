...
// Total pages
if($hasSearch) {
    $result1 = $dbCon->query("SELECT COUNT(*) AS id FROM ap_subjects WHERE name LIKE '%$search%'");
} else {
...
if($hasSearch) {
    $subjects = $dbCon->query("SELECT * FROM ap_subjects WHERE name LIKE '%$search%' LIMIT $start, $limit");
} else {
                ...
                <table class="table table-xs sm:table-sm md:table-md table-pin-rows table-pin-cols ">
                    <thead>
                        <tr>
                            ...
                            <th class="bg-slate-500 text-white">Units</th>
                            <th class="bg-slate-500 text-white">Credits</th>
                            <th class="bg-slate-500 text-white">Yearlevel</th>
