        ...
        <div class="px-4 flex justify-between flex-col gap-4">
            ...
            <div class="flex flex-col md:flex-row justify-between items-center w-full">
                ...
                <div class="flex gap-4 md:px-4 w-full md:w-auto">
                    <!-- Search bar -->
                    <form class="w-full md:w-[300px]" method="POST" action="<?= $_SERVER['PHP_SELF'] ?>" autocomplete="off">   
                ...
                <table class="table table-zebra table-md table-pin-rows table-pin-cols ">
                    <thead>
                        <tr>
                            ...
                            <td class="bg-slate-500 text-white text-center">Instructor</td>
                            ...
                            <?php foreach ($gradeReleaseRequests as $gradeReleaseRequest): ?>
                                <tr>
                                    ...
                                    <td class="flex gap-2 items-center justify-center">
                                        ...
                                        <button class="btn btn-sm btn-info" onclick="view_grade_<?= $gradeReleaseRequest['request_id'] ?>.showModal()">
                                            <i class="fa fa-eye"></i>
                                        </button>
                                        <?php if (in_array($gradeReleaseRequest['request_status'], ['pending'])): ?>
                                            <label class="btn btn-sm btn-success" for="approve-request-<?= $gradeReleaseRequest['request_id'] ?>">
                                                <i class="fa fa-thumbs-up"></i>
                                            </label>
                                            <label class="btn btn-sm btn-error" for="reject-request-<?= $gradeReleaseRequest['request_id'] ?>">
