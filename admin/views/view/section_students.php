                            ...
                            <?php while ($student = $students->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td class="flex justify-center items-center gap-4">
                                        <label for="remove-student-<?= $student['id'] ?>" class="btn btn-sm btn-error <?= $student['is_irregular'] == 1 ? 'btn-disabled' : '' ?>">Remove</label>
                                    </td>
                                </tr>
                            <?php } ?>
                        <?php } else { ?>
    ...
    <?php while ($student = $students->fetch_assoc()) { ?>
        ...
        <div class="modal" role="dialog">
            <div class="modal-box border border-error border-2">
                ...
                <p class="py-4">Are you sure you want to remove this student from this section? This action cannot be undone.</p>
