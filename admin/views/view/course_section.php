            ...
            <div class="flex flex-col md:flex-row justify-between">
                ...
                <div class="flex flex-col justify-between">
                    <div class="flex justify-between items-center">
                        <h1 class="text-[18px] md:text-[32px] font-bold"><?= $course['course_code'] ?> > <?= $yearLevel ?> > Sections</h1>
                    </div>
                ...
                <div class="flex items-center gap-4 md:px-4">
                    ...
                    <!-- Back button -->
                    <a href="./course.php?id=<?= $courseId ?>" class="btn btn-info"><i class="bx bxs-chevron-left"></i> Go Back</a>
                    
                    <!-- Create button -->
                    <label for="create-section" class="btn btn-success"><i class="bx bx-plus-circle"></i> Create</label>
                </div>
            </div>
                ...
                <table class="table table-zebra table-xs sm:table-sm md:table-md table-pin-rows table-pin-cols ">
                    <thead>
                        <tr>
                            ...
                            <td class="bg-slate-500 text-white text-center">Section Name</td>
                            <td class="bg-slate-500 text-white text-center">School Year</td>
                            ...
                            <?php while ($section = $sections->fetch_assoc()) { ?>
                                <tr>
                                    ...
                                    <td class="flex justify-center gap-4">
                                        <a href="./section_students.php?courseId=<?= $courseId ?>&sectionId=<?= $section['id'] ?>&yearLevel=<?= $yearLevel ?>" class="btn btn-info btn-sm">Students</a>
                                        <label for="edit-section-<?= $section['id'] ?>" class="btn bg-gray-400 text-white btn-sm">Edit</label>
        ...
        <div class="modal-box">
            ...
            <form class="flex flex-col gap-4 mt-4" method="post">
                ...
                <div class="grid grid-cols-2 gap-4">
                    ...
                    <button class="btn btn-success" name="create-section">Create</button>
                </div>
            </form>
        </div>
        ...
        <div class="modal" role="dialog">
            <div class="modal-box">
                ...
                <form class="flex flex-col gap-4 mt-4" method="post">
                    ...
                    <label class="flex flex-col gap-2">
                        <span class="font-bold text-[18px]">Section</span>
                        <input class="input input-bordered" name="name" placeholder="Enter section name" value="<?= $section['name'] ?>" required />
                    </label>
