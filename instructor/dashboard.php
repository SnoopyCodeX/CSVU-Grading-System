...
<main class="h-screen flex overflow-x-auto overflow-y-scroll">
    <?php require_once ("layout/sidebar.php") ?>
    <section class="h-screen mb-4 w-full px-4">
        ...
        <div class="px-4 flex justify-between flex-col gap-4 mb-4">
            <!-- Table Header -->
            ...
            <!-- Table Content -->
            <div class="overflow-x-auto md:overflow-x-hidden border border-gray-300 rounded-md mb-4"
                style="height: calc(100vh - 200px)">
                <table class="table table-zebra table-md table-pin-rows table-pin-cols mb-4">
                    <thead>
                        <tr class="hover">
                            ...
                            <td class="bg-[#276bae] text-white text-center">Units</td>
                            <td class="bg-[#276bae] text-white text-center">Credits Units</td>
                        </tr>
                    </thead>
                    <tbody>
