...
<main class="h-screen overflow-x-hidden flex">
    ...
    <section class="w-full px-4">
        ...
        <div class="px-4 flex justify-between flex-col gap-4">
            ...
            <div
                class=' overflow-hidden sm:pr-[48px] sm:grid sm:grid-cols-2 gap-4 md:grid-cols-2 lg:grid-cols-3 p-4 mt-8'>
                <?php if ($subjectsResult->num_rows > 0): ?>
                <?php foreach ($subjects as $key => $subject): ?>
                <a href="./view/subject_grade.php?subject=<?= $subject['subject_id'] ?>" class="">
                    <div
                        class='cursor-pointer hover:shadow hover:bg-[#27ae60] hover:text-white h-[300px] rounded-[5px] rounded-[5px] border border-gray-400 flex justify-center items-center p-4 flex-col gap-2 mb-4'>
